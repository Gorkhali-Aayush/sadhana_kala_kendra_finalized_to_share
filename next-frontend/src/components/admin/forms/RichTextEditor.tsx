...
export default function RichTextEditor({
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class:
          'prose prose-sm max-w-none focus:outline-none px-4 py-3 bg-white',
      },
    },
  });
  ...
  if (!editor) {
    return (
      <div>
        ...
        <div
          className="bg-gray-50 border border-gray-300 rounded-lg p-4 text-gray-500 flex items-center justify-center"
    ...
    <div>
      ...
      <div className="border border-gray-300 rounded-lg overflow-hidden bg-white">
        ...
        <div className="bg-slate-50 border-b border-slate-300 p-2 flex flex-wrap gap-1">
          ...
          <button
            type="button"
            onMouseDown={(e) => handleButtonClick(e, setLink)}
