      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
        ...
        <div className="text-center mb-12 md:mb-16 max-w-3xl mx-auto">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-600 font-['Roboto']">
            Explore moments of creative expression from our classrooms, stages, and outdoor sessions.
          </p>
        </div>

        {/* Featured Videos Section */}
        <div className="mb-12 md:mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-16 text-center font-Inter relative inline-block mx-auto w-fit pb-2">
            Featured Videos
          ...
          {activities.length > 0 ? (
            ...
            <div className="text-center text-red-500 text-lg py-12">No Featured Videos Found</div>
          )}
        </div>
